...
plot 'dados/RocketEulerGrav.dat' u 1:(abs($3-$2)) w l t 'Euler', 'dados/RocketRK2Grav.dat' u 1:(abs($3-$2)) w l t 'RK2', 'dados/RocketRK4Grav.dat' u 1:(abs($3-$2)) w l t 'RK4'

set term pos enh col 'Times,18'
set out 'figuras/Grav_error.eps'
replot
unset out
set term qt
