...
int main(void){
  ...
  FILE*Euler=fopen("dados/RocketEulerGrav.dat","w");      //Euler
  FILE*RK2=fopen("dados/RocketRK2Grav.dat","w");          //Runge-Kutta 2
  FILE*RK4=fopen("dados/RocketRK4Grav.dat","w");          //Runge-Kutta 4
