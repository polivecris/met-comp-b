...
int main(void){
  ...
  for(j=0;j<2;j++){
    if(j==0){
      Bo=30.0;
      euler=fopen("eEuler_h.dat","w");
      EC=fopen("eEC_h.dat","w");
      RK2=fopen("eRK2_h.dat","w");
      RK4=fopen("eRK4_h.dat","w");
      a=(qe*Bo)/me;
    }
    if(j==1){
      Bo=30000.0;
      euler=fopen("pEuler_h.dat","w");
      EC=fopen("pEC_h.dat","w");
      RK2=fopen("pRK2_h.dat","w");
      RK4=fopen("pRK4_h.dat","w");
      a=(qp*Bo)/mp;
    }
	...
	t=(i+1)*h;
      ...
      fprintf(euler,"%.12e %.12e %.12e %.12e %.12e\n",h,t,(cos(a*t)/a-x),(0.02*t-y),(sin(a*t)/a-z));
	...
	t=(i+1)*h;
      ...
      fprintf(EC,"%.12e %.12e %.12e %.12e %.12e\n",h,t,(cos(a*t)/a-x),(0.02*t-y),(sin(a*t)/a-z));
	...
	t=(i+1)*h;
      ...
      fprintf(RK2,"%.12e %.12e %.12e %.12e %.12e\n",h,t,(cos(a*t)/a-x),(0.02*t-y),(sin(a*t)/a-z));
	...
	t=(i+1)*h;
      ...
      fprintf(RK4,"%.12e %.12e %.12e %.12e %.12e\n",h,t,(cos(a*t)/a-x),(0.02*t-y),(sin(a*t)/a-z));
      printf("%d\n",N);
    }
    fclose(euler);
    fclose(EC);
