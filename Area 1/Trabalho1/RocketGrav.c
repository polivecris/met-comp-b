...
int main(void){
  ...
  FILE*Euler=fopen("RocketGravEuler.dat","w");      //Euler
  //FILE*erroEuler=fopen("EulerGravherros.dat","w+");
  FILE*RK2=fopen("RocketGravRK2.dat","w");          //Runge-Kutta 2
  //FILE*erroRK2=fopen("RK2Gravherros.dat","w+");
  FILE*RK4=fopen("RocketGravRK4.dat","w");          //Runge-Kutta 4
  //FILE*erroRK4=fopen("RK4Gravherros.dat","w+");
